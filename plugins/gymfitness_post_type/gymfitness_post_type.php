...
function gymfitness_classes_post_type()
{
	...
	$labels = array(
		...
		'parent_item_colon'     => __('Class Padre', 'gymfitness'),
		'all_items'             => __('Todas Las Classes', 'gymfitness'),
		'add_new_item'          => __('Agregar Class', 'gymfitness'),
		'add_new'               => __('Agregar Class', 'gymfitness'),
		'new_item'              => __('Nueva Class', 'gymfitness'),
		'edit_item'             => __('Editar Class', 'gymfitness'),
		'update_item'           => __('Actualizar Class', 'gymfitness'),
		'view_item'             => __('Ver Class', 'gymfitness'),
		'view_items'            => __('Ver Classes', 'gymfitness'),
		'search_items'          => __('Buscar Class', 'gymfitness'),
		...
		'insert_into_item'      => __('Insertar en Class', 'gymfitness'),
		'uploaded_to_this_item' => __('Agregado en Class', 'gymfitness'),
		'items_list'            => __('Lista de Classes', 'gymfitness'),
		'items_list_navigation' => __('Navegación de Classes', 'gymfitness'),
		'filter_items_list'     => __('Filtrar Classes', 'gymfitness'),
	);
	$args = array(
